...
var _whatInput = __webpack_require__(12);
...
(0, _jquery2.default)(function () {
    ...
    // home animation
    (function () {
        (0, _jquery2.default)('.home-title').animateCss('bounceInLeft');
        (0, _jquery2.default)('.home-menu').animateCss('bounceInRight');
    })();

    // mainmenu
    (function () {

        var nav = (0, _jquery2.default)('#mainmenu'),
            navButtun = nav.find('.nav-button');

        navButtun.on('click', function (event) {
            event.preventDefault();
            nav.toggleClass('is-visible');
        });

        (0, _jquery2.default)(document).on('click', function (event) {
            !(0, _jquery2.default)(event.target).is('.nav-button') && !(0, _jquery2.default)(event.target).is('.nav-button span') && nav.removeClass('is-visible');
        });
    })();
});
...
_foundation.Foundation.Timer = _foundationUtil5.Timer;
